...
class PPOTrainer(BaseRLTrainer):
    ...
    def load_checkpoint(self, checkpoint_path: str, *args, **kwargs) -> Dict:
        ...
        """
        # PyTorch >= 2.6 defaults weights_only=True, which rejects the yacs
        # Config object pickled into every pirlnav checkpoint. The files are
        # produced by this same codebase so unpickling them is safe.
